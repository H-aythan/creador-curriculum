var config = {
  ...
  meta: {
    title: "Resume builder", // Your website title here
    description:
      " Free, Fast & Easy PDF Download. 8+ Professional Resume Templates to Get You Hired Today! Stop Struggling With Word! Choose a Resume Template and Create Your Resume in 5 Minutes.", // Description here ( This one will show up in search engines)
    keywords:
      "Resumer Creation, Resume Creator,Resume Builder, Rresume Template, Cv Builder.",
  },
};
