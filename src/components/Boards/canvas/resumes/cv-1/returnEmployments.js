      ...
      item: (
        ...
        >
          ...
          <Text
            ...
            width={230}
            fontFamily="Poppins"
            text="Web developer in genoa for making websites and more"
            fontStyle="bold"
          ></Text>
          {/* Job Description */}
          <Text
            ...
            width={230}
            fontFamily="Poppins"
            text="Aug 2020 - sssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss sss 2021"
          ></Text>
        </Group>
      ),
