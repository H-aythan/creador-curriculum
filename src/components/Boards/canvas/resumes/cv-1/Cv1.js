...
class Cv1 extends Component {
  ...
  returnEducations() {
    ...
    for (let index = 0; index < this.props.values.educations.length; index++) {
      if (index > 0) {
        TotalHeightToAdd =
          TotalHeightToAdd + this.educationsHeighToAdd[index - 1];
      }
      ...
      skillsObjects[index] = {
        item: (
          ...
          >
            ...
            />
            {/* Spacing at the end */}
            <Rect height={6} width={60} y={220} x={30} />
          </Group>
        ),
        height: index > 0 ? this.educationsHeighToAdd[index - 1] : 0,
      };
  ...
  returnLanguages() {
    ...
    for (let index = 0; index < this.props.values.languages.length; index++) {
      if (index > 0) {
        TotalHeightToAdd =
          TotalHeightToAdd + this.languagesHeightToAdd[index - 1];
      }
        ...
        >
          ...
          >
            ...
            <Text
              ...
              y={
                this.addressRef
                  ? 224 + this.addressRef.getClientRect().height
                  : 234
              }
              x={30}
            />
            ...
            <Text
              ...
              y={
                this.addressRef
                  ? 240 + this.addressRef.getClientRect().height
                  : 249
              }
              fontSize={7}
              draggable
            ...
            <Text
              ...
              y={
                this.addressRef
                  ? 255 + this.addressRef.getClientRect().height
                  : 275
              }
              x={30}
            />
            <Text
              ...
              y={
                this.addressRef
                  ? 270 + this.addressRef.getClientRect().height
                  : 290
              }
              fontSize={7}
            />
          ...
          <Group
            ...
            y={
              this.infoHeight ? this.infoHeight.getClientRect().height + 5 : 155
            }
          >
            <Text
              width={300}
          ...
          <Group
            y={
              this.infoHeight
                ? this.infoHeight.getClientRect().height +
                  this.languagesRef.getClientRect().height +
                  10
                : 155
            }
          >
          ...
          <Group
            ...
            y={
              this.summaryRef ? this.summaryRef.getClientRect().height - 10 : 0
            }
          >
