...
const Cv3 =({form,Text,View,StyleSheet,web})=>{
  ...
  const styles = StyleSheet.create({
    ...
    point:{border:"2px solid black",borderRadius:"50%",width:"2px",height:"2px",marginRight:"2px",backgroundColor:"black"},
  })
  ...
  return<View style={[styles.page]}>
     <View style={styles.names}>
        <View style={{width:"65%",flexDirection:"column",overflow:"hidden"}}>
          ...
          <Text style={{fontSize:web?"12px":"10px",overflow:"hidden",height:"14px",opacity:"0.8",fontFamily:"Georgia"}}>{address}</Text>
          <Text style={{fontSize:web?"12px":"10px",overflow:"hidden",height:"14px",opacity:"0.8",fontFamily:"Georgia"}}>{phone}</Text>
        </View>
      </View>
      ...
      <View style={styles.borders}></View>
      <View style={styles.generics}>
        <Text style={{width:"20%",fontFamily:"Georgia"}}>Skills</Text>
        <View style={{width:"70%",flexDirection:"row",flexWrap:"wrap"}}>
              {skills.map((item,i)=>{
                ...
                return<View key={i} style={{opacity:"0.8",width:"50%",flexDirection:"row",alignItems:"center",marginTop:"2px"}}>
                  ...
                  <Text style={{fontSize:web?"9px":"8px",maxWidth:"100px",overflow:"hidden",height:"10px",fontFamily:"Georgia"}}>{item.skill} {number}</Text> 
                </View>
              })}
          </View>
      </View>
        ...
        <View style={{width:"70%",flexDirection:"row",flexWrap:"wrap"}}>
              {languages.map((item,i)=>{
                ...
                return<View key={i} style={{opacity:"0.8",width:"50%",flexDirection:"row",alignItems:"center",marginTop:"5px"}}>
                  <View style={styles.point}></View>
                  <Text style={{fontSize:web?"9px":"8px",maxWidth:"100px",overflow:"hidden",height:"10px",fontFamily:"Georgia"}}>{item.language} : {item.rating}</Text> 
                </View>
              })}
          </View>
      </View>
