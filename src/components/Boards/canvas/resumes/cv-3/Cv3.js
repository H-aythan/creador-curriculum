...
class Cv3 extends Component {
  ...
  returnEmployments() {
    ...
    for (let index = 0; index < this.props.values.employments.length; index++) {
      if (this.props.values.employments[index] !== null) {
        ...
        this.refs[index] != undefined
          ? (this.heighToAdd[index] = parseInt(
              this.refs[index].getClientRect().height
            ))
          : (this.heighToAdd[index] = 0);
  ...
  returnEducations() {
    ...
    for (let index = 0; index < this.props.values.educations.length; index++) {
      if (this.props.values.educations[index] !== null) {
        if (index > 0) {
          TotalHeightToAdd =
            TotalHeightToAdd + this.educationsHeighToAdd[index - 1] + 10;
        }
        educationsObjects[index] = {
          item: (
            <Group
              y={parseInt(TotalHeightToAdd)}
              ref={(node) => {
        ...
        this.educationsRefs[index] != undefined
          ? (this.educationsHeighToAdd[index] = parseInt(
              this.educationsRefs[index].getClientRect().height
            ))
          : (this.educationsHeighToAdd[index] = 0);
  ...
  returnSkills() {
    ...
    for (let index = 0; index < this.props.values.skills.length; index++) {
      skillsObject[index] = {
        item: (
          <Group y={heightToAdd} x={numberInLine == 1 ? 0 : 160}>
        ...
        >
          ...
          >
            <Text
              ...
              fontStyle="bold"
              fontSize={23}
              text={this.props.values.firstname}
            />
            <Text
              fontFamily="Georgia"
              fill="#A96366"
              ...
              y={30}
              fontSize={23}
              text={this.props.values.lastname}
            />
            <Text
              fontFamily="Georgia"
              fill="#3B3B3B"
            ...
            <Text
              ...
              y={75}
              fontSize={10}
              text={this.props.values.city + "," + this.props.values.postalcode}
            />
            <Text
              fontFamily="Georgia"
              fill="#3B3B3B"
          ...
          <Rect
            ...
            y={
              this.stageRef
                ? this.personalInfoRef.getClientRect().height +
                  55 /* This 60 is the padding added at the top + some spacing under personal info  40padding + 15 spacing */
                : 0
            }
            width={400}
            fill="#ededed"
          ...
          <Group
            ...
            y={
              this.stageRef
                ? this.personalInfoRef.getClientRect().height +
                  77 /* This 60 is the padding added at the top + some spacing under personal info  40padding + 15 spacing */
                : 0
            }
            ref={(node) => {
          ...
          <Rect
            ...
            height={1}
            y={
              this.stageRef && this.personalInfoRef
                ? this.personalInfoRef.getClientRect().height +
                  this.SummaryRef.getClientRect().height +
                  100 /* This 60 is the padding added at the top + some spacing under personal info  40padding + 15 spacing */
                : 0
            }
            width={400}
            fill="#ededed"
          ...
          <Group
            ...
            y={
              this.stageRef
                ? this.personalInfoRef.getClientRect().height +
                  this.SummaryRef.getClientRect().height +
                  120 /* This 60 is the padding added at the top + some spacing under personal info  40padding + 15 spacing */
                : 0
            }
            ref={(node) => {
              this.ExperienceRef = node;
            }}
          >
            {/* Section Title */}
          ...
          <Rect
            ...
            y={
              this.stageRef
                ? this.ExperienceRef.getClientRect().height +
                  this.personalInfoRef.getClientRect().height +
                  this.SummaryRef.getClientRect().height +
                  130 /* This 60 is the padding added at the top + some spacing under personal info  40padding + 15 spacing */
                : 0
            }
            width={400}
            fill="#ededed"
            ...
            y={
              this.stageRef
                ? this.personalInfoRef.getClientRect().height +
                  this.ExperienceRef.getClientRect().height +
                  this.SummaryRef.getClientRect().height +
                  150 /* This 60 is the padding added at the top + some spacing under personal info  40padding + 15 spacing */
                : 0
            }
            ref={(node) => {
          ...
          >
            ...
            {/* Secion Content */}
            <Group x={80}>{this.returnEducations()}</Group>
          </Group>
          {/* Seperator Line */}
          <Rect
            x={40}
            ...
            y={
              this.stageRef
                ? this.ExperienceRef.getClientRect().height +
                  ...
                  170 /* This 60 is the padding added at the top + some spacing under personal info  40padding + 15 spacing */
                : 0
            }
            width={400}
            fill="#ededed"
            ...
            y={
              this.stageRef
                ? this.EducationsRef.getClientRect().height +
                  ...
                  this.ExperienceRef.getClientRect().height +
                  this.SummaryRef.getClientRect().height +
                  188 /* This 60 is the padding added at the top + some spacing under personal info  40padding + 15 spacing */
                : 0
            }
            ref={(node) => {
              this.SkillsRef = node;
          ...
          <Rect
            ...
            y={
              this.stageRef
                ? this.ExperienceRef.getClientRect().height +
                  this.SkillsRef.getClientRect().height +
                  this.personalInfoRef.getClientRect().height +
                  this.SummaryRef.getClientRect().height +
                  this.EducationsRef.getClientRect().height +
                  199 /* This 60 is the padding added at the top + some spacing under personal info  40padding + 15 spacing */
                : 0
            }
            width={400}
            fill="#ededed"
            ...
            y={
              this.stageRef
                ? this.EducationsRef.getClientRect().height +
                  ...
                  this.ExperienceRef.getClientRect().height +
                  this.SummaryRef.getClientRect().height +
                  217 /* This 60 is the padding added at the top + some spacing under personal info  40padding + 15 spacing */
                : 0
            }
            ref={(node) => {
              this.languagesRef = node;
            }}
          >
            {/* Section Title */}
