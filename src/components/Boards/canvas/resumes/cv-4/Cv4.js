...
class Cv4 extends Component {
  ...
  returnEducations() {
    ...
    for (let index = 0; index < this.props.values.educations.length; index++) {
      if (index > 0) {
        TotalHeightToAdd =
          TotalHeightToAdd + this.educationsHeighToAdd[index - 1] + 5;
      }
  ...
  returnSkills() {
    ...
    for (let index = 0; index < this.props.values.skills.length; index++) {
      if (index > 0) {
        TotalHeightToAdd =
          TotalHeightToAdd + this.skillsHeightToAdd[index - 1] + 5;
      }
      skillsObjects[index] = {
        item: (
          <Group
          ...
          >
            <Text
              ...
              width={283}
              text={
                this.props.values.skills[index] !== null
            ...
            <Rect
              ...
              height={3}
              width={
                this.props.values.skills[index] != undefined
                  ? this.props.values.skills[index].rating
                  : 0
              }
            />
          </Group>
      ...
      this.skillsRefs[index] != undefined
        ? (this.skillsHeightToAdd[index] = parseInt(
            this.skillsRefs[index].getClientRect().height
          ))
        : (this.skillsHeightToAdd[index] = 0);
  ...
  returnLanguages() {
    ...
    for (let index = 0; index < this.props.values.languages.length; index++) {
      if (index > 0) {
        TotalHeightToAdd =
          TotalHeightToAdd + this.languagesHeightToAdd[index - 1] + 3;
      }
      ...
      this.languagesRefs[index] != undefined
        ? (this.languagesHeightToAdd[index] = parseInt(
            this.languagesRefs[index].getClientRect().height
          ))
        : (this.languagesHeightToAdd[index] = 0);
      ...
      >
        ...
        >
          ...
          >
            ...
            <Rect
              x={
                this.props.values.firstname.length +
                  this.props.values.lastname.length >
                23
                  ? 78
                  : 110
              }
            ...
            height={
              this.stageRef
                ? this.employmentsRef.getClientRect().height +
                  ...
                  this.profileRef.getClientRect().height +
                  10
                : 0
            }
            width={2}
          ...
          <Group
            x={170}
            y={this.headRef ? this.headRef.getClientRect().height + 20 : 0}
            ref={(node) => {
          ...
          <Group
            ...
            y={
              this.stageRef
                ? this.headRef.getClientRect().height +
                  this.profileRef.getClientRect().height +
                  30
                : 0
            }
          ...
          >
            ...
            <Text
              ...
              fontSize={6}
              fontFamily="Poppins"
              text={this.props.values.address + " ," + this.props.values.city}
            />
            <Text
              y={41}
              fontFamily="Poppins"
              fontSize={6}
              text={this.props.values.postalcode}
            />
            {/* Skill */}
          </Group>
          {/* Skills */}
          <Group
            ...
            y={
              this.headRef
                ? this.headRef.getClientRect().height +
                  this.detailsRef.getClientRect().height +
                  30
                : 0
            }
            ref={(node) => {
